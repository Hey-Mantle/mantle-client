...
export class MantleClient {
   ...
   * @param {string} idOrHandle - The ID or handle of the checklist to fetch
   * @returns {Promise<Checklist | null>} a promise that resolves to the checklist, or null if no checklist is found
   */
  getChecklist(idOrHandle: string): Promise<Checklist | null>;
  /**
   * Get a list of published checklists for the current customer including checklists after the active checklist
   * @param {string[]} [handles] - An optional array of handles to filter checklists. Will be formatted as a CSV string in the request body.
   * @returns {Promise<Checklist[]>} a promise that resolves to the customer's checklists
   */
  getChecklists(handles?: string[]): Promise<Checklist[]>;
    /**
     * Manually complete a checklist step rather than the step's completion trigger: usage event, usage metric, app event, etc.
     * @param {Object} params - The completion options
     * @param {string} params.idOrHandle - The ID or handle of the checklist to complete the step for
     * @param {string} params.stepIdOrHandle - The ID or handle of the checklist step to complete
     * @returns {Promise<boolean>} true if the step was completed successfully
     */
     ...
     * @param {Object} params - The skip options
     * @param {string} params.idOrHandle - The ID or handle of the checklist to skip the step for
     * @param {string} params.stepIdOrHandle - The ID or handle of the checklist step to skip
     * @returns {Promise<boolean>} true if the step was skipped successfully
     */
   ...
   * @param {string} params.idOrHandle - The ID or handle of the checklist to show
   * @returns {Promise<boolean>} true if the checklist was shown successfully
   */
  showChecklist(params: { idOrHandle: string }): Promise<boolean>;
  /**
   ...
   */
  sendUsageEvents({ events }: { events: UsageEvent[] }): Promise<boolean>;
  /**
   ...
   */
  addPaymentMethod({ returnUrl }: { returnUrl: string }): Promise<SetupIntent>;
  /**
